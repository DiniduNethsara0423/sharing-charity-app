...
async function main() {
  ...
  try {
    await connection.query(
      'ALTER TABLE chatbot_query MODIFY created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP'
    );
    await connection.query(
      'ALTER TABLE chatbot_query MODIFY updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'
    );
    console.log('Migration applied: chatbot_query.created_at and updated_at now have timestamp defaults');
  } finally {
